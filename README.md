# Tamira Carter | Strategic Portfolio 🚀

**Market Strategy & Research Analyst Portfolio**  
*Bridging the gap between raw analytics and boardroom strategy.*
...
### 1. The "Inflation Firewall" Chart (Cardinal Case)
A custom-coded Waterfall Chart using native CSS/JS (no images). This ensures financial data renders crisply on all screen sizes, demonstrating technical precision to CFO-level stakeholders.

### 2. Mobile "Fit-to-Screen" Logic
All charts are engineered with responsive breakpoints.
- **Desktop:** Full expansive view.
- **Mobile:** Smart scaling and font adjustment to ensure data is legible without horizontal scrolling.

### 3. Smart Navigation
A "Sticky Header" system allows recruiters to jump instantly between **Impact**, **Market**, and **Profit** pillars without losing context.

---

## 🚀 Deployment
This project is deployed via **GitHub Pages**.
- **Live URL:** [Request Live Link]
- **Branch:** `main` (root directory)

---

## © Copyright
All rights reserved to **Tamira Carter**.  
*Designed & Engineered by Strategic Tech Partner.*
